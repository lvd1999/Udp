...
<head>
  ...
  <title>Book a Doctor to you</title>
        ...
        <div class="container">
          <div class="col-md-12">
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="#"><img src="img/logo.png" class="img-responsive" style="width: 120px; margin-top: -28px;"></a>
            </div>
...
<!--            <div class="banner-logo text-center">
            ...
            <div class="banner-text text-center">
                <h1 class="drbook" color="white">DR.Book</h1>
              <h1 class="white">Easy, convenient, online doctor services.</h1>
