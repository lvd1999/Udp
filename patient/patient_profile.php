            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                ...
                                <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                                    <a class="dropdown-item" href="profile.php?patientId=<?php echo $userRow['icPatient']; ?>">
                    ...
                    if (is_null($userRow['profile_image'])) {
                        echo "<img src='../img/avatar.jpg'  id='profileDisplay'>";
                    } else {
                        echo "<img src='" . "../img/" . $userRow['profile_image'] . "'  id='profileDisplay'>";
                    }
                    ?>
