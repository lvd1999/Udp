    ...
    foreach ($result as $key => $value) {
        ?>
                    ...
                    <tr>
                        ...
                        <td><div class="col" id="user_data_3"><?php echo $result[$key]['speciality_name']; ?> </div></td>
                        <td><div class="col" id="user_data_4"><?php echo $result[$key]['date']; ?> </div></td>
                        <td><div class="col" id="user_data_5"><?php echo $result[$key]['time']; ?> </div></td>
        <?php
